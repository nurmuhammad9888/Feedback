...
export const EditFeedback = () => {
    ...
    const handlerSubmit = (evt) => {
        ...
        axios.put("http://localhost:9090/feedback/put/" + id,{
    ...
    const nahandlerDelet = (id) => {
        axios.delete("http://localhost:9090/feedback/delete/" + id).then(res => {
            if(res.status === 200){
                navgate(-1)
                console.log(res);
            }
    ...
    return (
        <Box sx={{width:"540px", mx:"auto", marginTop:"92px"}}>
            ...
            <Box sx={{width:"100%", backgroundColor:"#fff", marginTop:"68px",borderRadius:"10px", padding:"52px 42px 40px 42px", position:"relative"}}>
                <img style={{position:"absolute", top:"-25px"}} width={56} height={56} src={pincelPost} alt="plus icon"/>
                ...
                <Box sx={{marginTop:"40px"}}>
                    <form onSubmit={handlerSubmit}>
                        ...
                        <Box sx={{marginTop:"32px"}}>
                            <Button onClick={() => nahandlerDelet(id)} sx={{backgroundColor:"#D73737",borderRadius: "10px",fontSize:"14px", color:"#F2F4FE", fontFamily:"inherit", fontWeight:"700", textTransform:"capitalize", padding:"12px 24px",'&:hover': {backgroundColor:"#AD1FEA"}}}>Delete</Button>
                            <Button onClick={() => navgate(-1)} sx={{backgroundColor:"#3A4374",borderRadius: "10px",fontSize:"14px", color:"#F2F4FE", fontFamily:"inherit", fontWeight:"700", textTransform:"capitalize", padding:"12px 24px", marginLeft:"102px",'&:hover': {backgroundColor:"#AD1FEA"}}}>Cancel</Button>
                            <Button sx={{backgroundColor:"#AD1FEA",borderRadius: "10px",fontSize:"14px", color:"#F2F4FE", fontFamily:"inherit", fontWeight:"700", textTransform:"capitalize", padding:"12px 24px", marginLeft:"16px",'&:hover': {backgroundColor:"#AD1FEA"}}} type='submit'>Add Feedback</Button>
                        </Box>
                    </form>
                </Box>
            </Box>
